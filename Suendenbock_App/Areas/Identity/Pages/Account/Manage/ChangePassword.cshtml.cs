...
namespace Suendenbock_App.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Das alte Passwort ist erforderlich.")]
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Benutzer mit ID '{_userManager.GetUserId(User)}' konnte nicht geladen werden.");
            }
