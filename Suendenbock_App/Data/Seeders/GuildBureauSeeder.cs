...
namespace Suendenbock_App.Data.Seeders
{
    ...
    public static class LizenzenSeeder
    {
        public static void Seed(ApplicationDbContext context)
        {
            if (!context.Set<Lizenzen>().Any())
            {
                context.Set<Lizenzen>().AddRange(
                    new Lizenzen { Name = "Ausbildungslizenz" },
                    new Lizenzen { Name = "Verhaftungslizenz" },
                    new Lizenzen { Name = "Söldnerslizenz" },
                    new Lizenzen { Name = "Medizinerlizenz" },
                    new Lizenzen { Name = "Literaturlizenz" },
                    new Lizenzen { Name = "Händlerlizenz" },
                    new Lizenzen { Name = "Wildereilizenz - Wild" },
                    new Lizenzen { Name = "Wildereilizenz - Exoten" },
                    new Lizenzen { Name = "Fischereilizenz" },
                    new Lizenzen { Name = "Prostitutionslizenz" },
                    new Lizenzen { Name = "Handwerkslizenz - Metallarbeiten" },
                    new Lizenzen { Name = "Handwerkslizenz - Holzarbeiten" },
                    new Lizenzen { Name = "Handwerkslizenz - Steinarbeiten" },
                    new Lizenzen { Name = "Handwerkslizenz - Leder-& Stoffarbeiten" }
                );
                context.SaveChanges();
            }
        }
