        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MagicClasses_LightCards_LightCardId",
                        column: x => x.LightCardId,
                        principalTable: "LightCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specializations_MagicClasses_MagicClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Characters_Specializations_SpecializationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterMagicClasses_Specializations_SpecializationId",
                        column: x => x.SpecializationId,
                        principalTable: "Specializations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterMagicClasses_SpecializationId",
                table: "CharacterMagicClasses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Characters_SpecializationId",
                table: "Characters",
                column: "SpecializationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MagicClasses_LightCardId",
                table: "MagicClasses",
                column: "LightCardId");

            migrationBuilder.CreateIndex(
                name: "IX_Specializations_MagicClassId",
