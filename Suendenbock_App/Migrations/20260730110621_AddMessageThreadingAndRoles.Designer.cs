...
namespace Suendenbock_App.Migrations
{
    ...
    [Migration("20260730110621_AddMessageThreadingAndRoles")]
    partial class AddMessageThreadingAndRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Biom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Character", b =>
                {
                    ...
                    b.Property<int>("CastedSpellsCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.EventChore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EventChores");
                });

            modelBuilder.Entity("Suendenbock_App.Models.Domain.EventRSVP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.FeldEffekt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FeldEffekte");
                });

            modelBuilder.Entity("Suendenbock_App.Models.Domain.ForumCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.ForumReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.ForumThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Monster", b =>
                {
                    ...
                    b.Property<int?>("EquippedPosition")
                        .HasColumnType("int");

                    b.Property<bool>("HasBoughtTrophy")
                        .HasColumnType("bit");

                    b.Property<bool>("HasSlainTrophy")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("HasBoughtTrophy");

                    b.HasIndex("HasSlainTrophy");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.MonthlyEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.MonthlyPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.NewsComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.NewsItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("NotifyForumReplies")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyForumThreads")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyNews")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyPolls")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Poll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.PollOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.PollVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.PushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("LastSuccessfulPush")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReporterCharacterId");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.EventChore", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.MonthlyEvent", "Event")
                        .WithMany("Chores")
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.ForumReply", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.Character", "AuthorCharacter")
                        .WithMany()
                        .HasForeignKey("AuthorCharacterId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Suendenbock_App.Models.Domain.ApplicationUser", "AuthorUser")
                        .WithMany()
                        .HasForeignKey("AuthorUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Suendenbock_App.Models.Domain.ForumThread", "Thread")
                        .WithMany("Replies")
                        .HasForeignKey("ThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AuthorCharacter");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.ForumThread", b =>
                {
                    ...
                    b.HasOne("Suendenbock_App.Models.Domain.ForumCategory", "Category")
                        .WithMany("Threads")
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.MonthlyEvent", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.NewsComment", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.NewsItem", "NewsItem")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.PollOption", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.Poll", "Poll")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.PollVote", b =>
                {
                    ...
                    b.HasOne("Suendenbock_App.Models.Domain.PollOption", "PollOption")
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Ticket", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.Character", "ReporterCharacter")
                        .WithMany()
                        .HasForeignKey("ReporterCharacterId");

                    b.HasOne("Suendenbock_App.Models.Domain.ApplicationUser", "ReporterUser")
                        .WithMany()
                        .HasForeignKey("ReporterUserId");

                    b.HasOne("Suendenbock_App.Models.Domain.ApplicationUser", "ResolvedBy")
                        .WithMany()
                        .HasForeignKey("ResolvedById");

                    b.Navigation("ReporterCharacter");
