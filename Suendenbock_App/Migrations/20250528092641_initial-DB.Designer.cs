...
namespace Suendenbock_App.Migrations
{
    ...
    [Migration("20250528092641_initial-DB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Guild", b =>
                {
                    ...
                    b.Property<int>("Abenteuerrang")
                        .HasColumnType("int");

                    b.Property<int>("AbenteuerrangId")
                        .HasColumnType("int");

                    b.Property<int>("Anmeldungsstatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Zauber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Character", b =>
                {
                    ...
                    b.HasOne("Suendenbock_App.Models.Domain.Eindruck", null)
                        .WithMany("Charaktere")
                    ...
                    b.HasOne("Suendenbock_App.Models.Domain.Lebensstatus", null)
                        .WithMany("Characters")
                    ...
                    b.HasOne("Suendenbock_App.Models.Domain.Rasse", null)
                        .WithMany("Characters")
            ...
            modelBuilder.Entity("Suendenbock_App.Models.Domain.Zauber", b =>
                {
                    b.HasOne("Suendenbock_App.Models.Domain.MagicClassSpecialization", "MagicSpecialization")
                        .WithMany()
                        .HasForeignKey("MagicClassSpecializationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("MagicSpecialization");
                });
